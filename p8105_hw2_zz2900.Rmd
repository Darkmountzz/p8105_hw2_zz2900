...
This dataset contains entrance and exit information for each listed subway station in New York City, and it has 1868 observations and 32 rows.

Column names are formatted and forced to lowercase, 20 variables are selected from the original dataset, including line, station name, station latitude and longitude, whether the route (1-11) stops at that station, entry type, entry or exit, vending and ADA compliance.
